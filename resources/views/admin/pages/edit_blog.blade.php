        ...
        <div class="box-content">
            ...
            <fieldset>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="blog_title" class="span6 typeahead" id="typeahead" value="<?php echo $blog_info->blog_title; ?>">
                        <input type="text" name="blog_id" value="<?php echo $blog_info->blog_id; ?>">
                    </div>
                </div>
